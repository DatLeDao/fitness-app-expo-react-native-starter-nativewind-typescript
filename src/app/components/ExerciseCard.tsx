...
export default function ExerciseCard({ 
  ...
  return (
    <TouchableOpacity 
        ...
        onPress={onPress}
    >
        <View className="flex-row p-6 border border-gray-200">
            <View className="w-20 h-20 bg-white rounded-xl mr-4 overflow-hidden border border-gray-200">
                {item.image ? (
                    <Image 
            ...
            <View>
                ...
                <Text className="text-sm mb-2 text-gray-500" numberOfLines={2}>
