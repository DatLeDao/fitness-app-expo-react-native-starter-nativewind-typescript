import { View, Text, Modal, SafeAreaView, StatusBar, TouchableOpacity, TextInput, RefreshControl, FlatList } from "react-native";
    ...
    return (
        <Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={onClose}>
            <SafeAreaView className="flex-1 bg-white">
                ...
                {/* Header */}
                <View className="bg-white px-4 pt-4 pb-2 shadow-sm border-b border-gray-300">
                    ...
                    {/* Search Bar */}
                    <View className="flex-row items-center bg-gray-100 rounded-xl px-4 border border-gray-300 mb-4">
