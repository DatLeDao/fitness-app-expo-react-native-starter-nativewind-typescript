      ...
      >
        {workouts.length === 0 ? (
          <View className="bg-white rounded-2xl p-8 items-center">
            <Ionicons name="barbell-outline" size={64} color="#9CA3EF" />
          ...
          <View className="space-y-4 gap-4">
            {workouts.map((workout) => (
              <TouchableOpacity
                key={workout._id}
                className="bg-white rounded-2xl p-6 shadow-sm border border-gray-300"
                activeOpacity={0.7}
                onPress={() => {
                  router.push({
              ...
              >
                ...
                <View className="flex-row items-center justify-between mb-4">
                  ...
                  <View className="bg-blue-100 rounded-full w-12 h-12 justify-center items-center">
                ...
                <View className="flex-row items-center justify-between mb-4">
                  <View className="flex-row items-center">
                    <View className="bg-gray-100 border border-gray-300 rounded-lg px-3 py-2 mr-3">
                      <Text className="text-sm font-medium text-gray-700">
                        {workout.exercises?.length || 0} exercises
                      </Text>
                    </View>
                    <View className="bg-gray-100 border border-gray-300 rounded-lg px-3 py-2">
                      <Text className="text-sm font-medium text-gray-700">
